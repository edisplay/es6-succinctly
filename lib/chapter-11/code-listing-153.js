...
try {
  for (var _iterator = fibonacci(5)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var n = _step.value;
...
var numbers = [].concat(_toConsumableArray(fibonacci(5)));
console.log(numbers);;
